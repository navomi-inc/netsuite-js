...
var _ = require('lodash'),
	...
	// axios = require('axios'),
	axios = require('../../node_modules/axios/index'),
	rest = axios.create({
...
Configuration.prototype.createConnection = function(skipDiscovery) {
	...
	var connect = function(resolve, reject) {
		...
		createClient(_this._wsdl, {
			...
			.then(function(client) {
				...
				_this.client = client;
				console.log("[NESTUITE-JS][CONFIGURATION][createConnection][createClient] client 2: ", client);
				resolve(client);
			})
			.catch(function(err) {
	...
	return new Promise(function(resolve, reject) {
		...
		// 	}
		// }, function(res) {
		// 	console.log("[NESTUITE-JS][CONFIGURATION][createConnection][authHeader] res: ", res);
		// 	var buffer = [];
